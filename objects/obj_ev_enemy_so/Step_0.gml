...
if (delayedact >= 2)
{
    ...
    if (cycle == 1 || cycle == 0)
    {
        ...
        {
            var dir = sprite_index
            if (dir == asset_get_index("spr_ev_un_soldier_r_gun"))
            {
                obj = collision_line(x, y, player_x, y, asset_get_index("obj_boulder"), false, true)
                if (obj != noone && obj != id)
                {
                    ...
                    with (obj)
                    {
                        ...
                        instance_create_layer(x, y, "Effects", asset_get_index("obj_og_explosion"))
                ...
                {
                    obj = collision_line(x, y, player_x, y, asset_get_index("obj_enemy_parent"), false, true)
                    if (obj != noone && obj != id)
                    {
                        audio_play_sound(asset_get_index("snd_ex_enemyexplosion_007"), 3, false)
                        with (obj)
                    ...
                    {
                        obj = collision_line(x, y, player_x, y, asset_get_index("obj_npc_talk"), false, true)
                        if (obj != noone && obj != id)
                        {
                            audio_play_sound(asset_get_index("snd_ex_enemyexplosion_007"), 3, false)
                            with (obj)
            ...
            else if (dir == asset_get_index("spr_ev_un_soldier_l_gun"))
            {
                obj = collision_line(x, y, player_x, y, asset_get_index("obj_boulder"), false, true)
                if (obj != noone && obj != id)
                {
                    ...
                    with (obj)
                    {
                        ...
                        if (!audio_is_playing(asset_get_index("snd_explosion")))
                        {
                            soundscript = asset_get_index("scr_play_sound")
                            script_execute(soundscript, asset_get_index("snd_explosion"), 1, false)
                        }
                        instance_destroy()
                    }
            ...
            else if (dir == asset_get_index("spr_ev_un_soldier_d_gun"))
            {
                obj = collision_line(x, y, x, player_y, asset_get_index("obj_boulder"), false, true)
                if (obj != noone && obj != id)
                {
                    audio_play_sound(asset_get_index("snd_ex_enemyexplosion_007"), 3, false)
                    with (obj)
                ...
                {
                    obj = collision_line(x, y, x, player_y, asset_get_index("obj_enemy_parent"), false, true)
                    if (obj != noone && obj != id)
                    {
                        audio_play_sound(asset_get_index("snd_ex_enemyexplosion_007"), 3, false)
                        with (obj)
                    ...
                    {
                        obj = collision_line(x, y, x, player_y, asset_get_index("obj_npc_talk"), false, true)
                        if (obj != noone && obj != id)
                        {
                            audio_play_sound(asset_get_index("snd_ex_enemyexplosion_007"), 3, false)
                            with (obj)
                        ...
                        else if ((!(collision_line(x, y, x, player_y, asset_get_index("obj_obstacle_parent"), false, true))) && (!(collision_line(x, y, x, player_y, asset_get_index("obj_enemy_parent"), false, true))) && (!(collision_line(x, y, x, player_y, asset_get_index("obj_npc_talk"), false, true))) && collision_line(x, y, x, player_y, asset_get_index("obj_player"), false, true) && y < player_y)
                        {
                            instance_create_layer(x, (y - 15), "Effects", asset_get_index("obj_shutter_flash"))
                            audio_play_sound(asset_get_index("snd_ex_enemyexplosion_007"), 3, false)
                            with (585)
            ...
            else if (dir == asset_get_index("spr_un_soldier_u_gun"))
            {
                obj = collision_line(x, y, x, player_y, asset_get_index("obj_boulder"), false, true)
                if (obj != noone && obj != id)
                {
